...
object MtkXFlashConstants {
    ...
    object Cmd {
        ...
        // Standard Protocol Commands (0x01xxxx)
        const val CONNECT = 0x010000
        const val DOWNLOAD = 0x010001
        const val UPLOAD = 0x010002
        const val GET_TARGET_CONFIG = 0x010001
        const val CUSTOM_CMD = 0x010002
        const val FORMAT = 0x010003
        const val WRITE_DATA = 0x010004
        const val READ_DATA = 0x010005
        const val FORMAT_PARTITION = 0x010006
        ...
        const val SET_RUNTIME_PARAMETER = 0x01000A
        const val OTP_OPERATION = 0x01000B
        const val READ_PARTITION_TABLE = 0x01000C
        const val INITIALIZE_DRAM = 0x01000F
        const val READ_DATA_STORAGE = 0x010010

        // Device Control Configuration Commands (0x02xxxx)
        ...
        // Information Query Commands (0x04xxxx)
        ...
        // Custom Control Commands (0x08xxxx)
    ...
    object DataType {
        ...
        const val NONE = 0x00
        const val PARAM = 0x01
        const val STORAGE = 0x02
        const val DEV_CTRL = 0x03
        const val STATUS = 0x04
        const val ACK = 0x05
        const val NACK = 0x06
        const val PROGRESS = 0x07
        const val DEBUG = 0x08
        const val PACKET = 0x09
        const val FEEDBACK = 0x0A
    }
